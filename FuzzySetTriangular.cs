...
namespace Angora
{
    public class FuzzySetTriangular : GH_Component
    {
        ...
        public FuzzySetTriangular()
          : base("FuzzySet Triangular", "Triangular",
              "FuzzySet Triangular",
              "Angora", "Fuzzy Sets")
        {
        }
        ...
        {
            pManager.AddGenericParameter("FuzzySet", "FS", "Triangular fuzzy set", GH_ParamAccess.item);
        }
        ...
        {
            get { return new Guid("{4eb5e6e9-cd5b-4d55-8ae5-410365316256}"); }
        }
    }
}
